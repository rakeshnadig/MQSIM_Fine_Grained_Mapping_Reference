...
#define All_VALID_PAGE 0x0000000000000000ULL
	...
	*/
	...
	public:
		...
		//FGM 
		unsigned int Invalid_mu_count;
		static unsigned int Mu_vector_size;
		bool** Valid_page; 
	...
	public:
		...
		//FGM - Invalidate page in block(block, page) --> Is page valid(block, page) --> Is mu valid(block, page, mu)
		...
		//FGM - New internal function to invalidate mapping units
		bool Is_mu_valid(Block_Pool_Slot_Type* block, flash_page_ID_type page_id, flash_mu_ID_type mu_id);
