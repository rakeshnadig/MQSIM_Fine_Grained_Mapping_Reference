...
namespace SSD_Components
{
	...
	*/
	...
	public:
		...
		//FGM - GC functions for the GC Page buffer implementation
		bool Insert_to_GC_buffer (  stream_id_type stream_id,  LPA_type lpa,  page_status_type page_status_bitmap );
		NVM_Transaction_Flash_WR* Merge_and_flush_GC_buffer (  stream_id_type stream_id);
	...
	private:
		...
		Data_Cache_Flash** per_stream_page_buffer;
		Data_Cache_Flash** per_stream_GC_buffer;
		...
		//FGM - 
		NVM_Transaction_Flash_WR* merge_and_flush_page_buffer( stream_id_type stream_id);
