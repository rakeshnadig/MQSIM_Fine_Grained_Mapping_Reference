...
namespace SSD_Components
{
	...
	public:
		...
		virtual bool Insert_to_GC_buffer ( stream_id_type stream_id, LPA_type lpa,  page_status_type page_status_bitmap ) =0;
		virtual NVM_Transaction_Flash_WR* Merge_and_flush_GC_buffer ( stream_id_type stream_id) = 0;
