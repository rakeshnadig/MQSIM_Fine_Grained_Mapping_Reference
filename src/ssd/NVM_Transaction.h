...
namespace SSD_Components
{
	...
	public:
		...
		Transaction_Source_Type Source;
		Transaction_Type Type;
		//std::list<NVM_Transaction*>::iterator RelatedNodeInQueue;//Just used
		//for high performance linkedlist insertion/deletion
		
		sim_time_type Issue_time;
		/* Used to calculate service time and transfer time for a normal
		 * read/program operation used to respond to the host IORequests.
		In other words, these variables are not important if FlashTransactions
