...
namespace NVM
{
	namespace FlashMemory
	{
		...
		public:
			...
			//FGM - Extended Page to support mapping units
			flash_mu_ID_type MUID;

			Physical_Page_Address(
					const flash_channel_ID_type channel_id = 0, 
					...
					const flash_mu_ID_type mu_id = 0)
			{
