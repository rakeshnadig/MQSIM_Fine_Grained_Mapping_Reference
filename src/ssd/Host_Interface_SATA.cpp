...
namespace SSD_Components
{
	...
	Host_Interface_SATA::Host_Interface_SATA(const sim_object_id_type& id,
		const uint16_t ncq_depth, const LHA_type max_logical_sector_address, const unsigned int sectors_per_page,unsigned int sectors_per_mu, Data_Cache_Manager_Base* cache) :
		Host_Interface_Base(id, HostInterface_Types::SATA, max_logical_sector_address, sectors_per_page, sectors_per_mu, cache), ncq_depth(ncq_depth)
	{
